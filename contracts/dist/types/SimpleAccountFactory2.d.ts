...
export interface SimpleAccountFactory2Interface extends utils.Interface {
    functions: {
...
export interface SimpleAccountFactory2 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SimpleAccountFactory2Interface;
